...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(verbose_name=_("Description"), default='Default description...update it please...')
    country = CountryField(verbose_name=_("Country"), default='IN', blank_label='(select country)', )
    city = models.CharField(verbose_name=_("City"), max_length=180, default='Hyderabad')
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=20, default='100')
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default='Gachibowli')
    ...
    bathrooms = models.DecimalField(verbose_name=_("Bathrooms"), default=1.0, decimal_places=2, max_digits=2)
    ...
    property_type = models.CharField(verbose_name=_("Property Type"), choices=PropertyType.choices, default=PropertyType.OTHER, max_length=50)
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    property = models.ForeignKey(Property, verbose_name=_("Property"), related_name='property_views', on_delete=models.CASCADE)

    def __str__(self):
        return f"Total views - {self.property.title} is - {self.property.views} view(s)"
