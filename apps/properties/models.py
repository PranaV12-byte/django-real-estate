...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        ...
        default="Default description...update it please...",
    )
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=20, default="100"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Gachibowli"
    )
    ...
    bathrooms = models.DecimalField(
        verbose_name=_("Bathrooms"), default=1.0, decimal_places=2, max_digits=2
    )
